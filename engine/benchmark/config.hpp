...
inline constexpr std::array BENCHMARK_MATCHUPS = {
    ...
    MatchConfig{.player1Name = "Minimax8_Mad2",    .player2Name = "MCTS800_Mad2",     .games =  1024/8, .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS800_Mad2",     .player2Name = "Minimax8_Mad2",    .games =  1024/8, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad2",    .player2Name = "Minimax8_Mad10",   .games =  1024/8, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad10",   .player2Name = "Minimax8_Mad2",    .games =  1024/8, .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS800_Mad10",    .player2Name = "Minimax8_Mad2",    .games =  1024/8, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad10",   .player2Name = "MCTS800_Mad2",     .games =  1024/8, .maxTurns = 2048},
