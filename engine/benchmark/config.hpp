...
inline constexpr std::array BENCHMARK_MATCHUPS = {
    ...
    // Normal vs other Mad
    MatchConfig{.player1Name = "Minimax8",         .player2Name = "Minimax12_Mad2",   .games =  512,  .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax12_Mad2",   .player2Name = "Minimax8",         .games =  512,  .maxTurns = 2048},
    ...
    MatchConfig{.player1Name = "Minimax8_Mad2",    .player2Name = "MCTS800_Mad2",     .games =  1024/2, .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS800_Mad2",     .player2Name = "Minimax8_Mad2",    .games =  1024/2, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad2",    .player2Name = "Minimax8_Mad10",   .games =  1024/2, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad10",   .player2Name = "Minimax8_Mad2",    .games =  1024/2, .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS800_Mad10",    .player2Name = "Minimax8_Mad2",    .games =  1024/2, .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8_Mad10",   .player2Name = "MCTS800_Mad2",     .games =  1024/2, .maxTurns = 2048},
    ...
    MatchConfig{.player1Name = "MCTS1200",      .player2Name = "RandomPlayer",  .games = 1024, .maxTurns = 2048},
    MatchConfig{.player1Name = "RandomPlayer",  .player2Name = "MCTS1200",      .games = 1024, .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS1200",      .player2Name = "GreedyPlayer",  .games = 1024, .maxTurns = 2048},
    MatchConfig{.player1Name = "GreedyPlayer",  .player2Name = "MCTS1200",      .games = 1024, .maxTurns = 2048},
