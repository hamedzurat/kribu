...
inline constexpr std::array BENCHMARK_MATCHUPS = {
    ...
    MatchConfig{.player1Name = "MCTS800",          .player2Name = "MCTS800_Mad10",    .games =  128/4,  .maxTurns = 2048},
    MatchConfig{.player1Name = "MCTS800_Mad10",    .player2Name = "MCTS800",          .games =  128/4,  .maxTurns = 2048},
    ...
    // Normal vs other Mad
    MatchConfig{.player1Name = "Minimax8",         .player2Name = "Minimax12_Mad2",   .games = 2048/2,  .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax12_Mad2",   .player2Name = "Minimax8",         .games = 2048/2,  .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax8",         .player2Name = "Minimax12_Mad10",  .games =  256,  .maxTurns = 2048},
    MatchConfig{.player1Name = "Minimax12_Mad10",  .player2Name = "Minimax8",         .games =  256,  .maxTurns = 2048},
